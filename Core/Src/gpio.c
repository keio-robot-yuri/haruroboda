...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4|LD2_Pin|GPIO_PIN_10|GPIO_PIN_15, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PA4 PAPin PA10 PA15 */
  GPIO_InitStruct.Pin = GPIO_PIN_4|LD2_Pin|GPIO_PIN_10|GPIO_PIN_15;
